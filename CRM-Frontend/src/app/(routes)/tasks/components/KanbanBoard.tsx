...
import { Ban, CheckCheck, ListTodo, Loader } from 'lucide-react';

const defaultCols = [
   {
      id: 'todo' as const,
      title: 'في الانتظار',
      icon: <ListTodo className='h-6 w-6 text-primary/50' />
   },
   {
      id: 'in-progress' as const,
      title: 'قيد التنفيذ',
      icon: <Loader className='h-6 w-6 text-primary/50' />
   },
   {
      id: 'done' as const,
      title: 'تم',
      icon: <CheckCheck className='h-6 w-6 text-primary/50' />
   },
   {
      id: 'canceled' as const,
      title: 'ملغي',
      icon: <Ban className='h-6 w-6 text-primary/50' />
   }
] satisfies Column[];
...
const initialTasks: Task[] = [
   {
      id: 'task1',
      columnId: 'done',
      content: 'بدء المشروع والتخطيط'
   },
   {
      id: 'task2',
      columnId: 'canceled',
      content: 'جمع المتطلبات من أصحاب المصلحة'
   },
   {
      id: 'task3',
      columnId: 'done',
      content: 'إنشاء نماذج أولية ونماذج أولية'
   },
   {
      id: 'task4',
      columnId: 'in-progress',
      content: 'تطوير تخطيط الصفحة الرئيسية'
   },
   {
      id: 'task5',
      columnId: 'in-progress',
      content: 'تصميم مخطط الألوان والطباعة'
   },
   {
      id: 'task6',
      columnId: 'todo',
      content: 'تصميم الشعار والعلامة التجارية'
   },
   {
      id: 'task7',
      columnId: 'todo',
      content: 'تصميم واجهة المستخدم'
   },
   {
      id: 'task8',
      columnId: 'canceled',
      content: 'تطوير صفحة الخدمات'
   },
   {
      id: 'task9',
      columnId: 'todo',
      content: 'تطوير صفحة المنتجات'
   },
   {
      id: 'task10',
      columnId: 'todo',
      content: 'تطوير صفحة الاتصال'
   },
   {
      id: 'task11',
      columnId: 'canceled',
      content: 'تطوير صفحة المدونة'
   },
   {
      id: 'task12',
      columnId: 'todo',
      content: 'إجراء الاختبار وإصلاح الأخطاء'
   },
   {
      id: 'task13',
      columnId: 'todo',
      content: 'تحسين تجربة المستخدم'
   }
];
