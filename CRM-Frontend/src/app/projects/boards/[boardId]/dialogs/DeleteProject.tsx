   ...
   const onDelete = async () => {
      ...
      try {
         ...
         toast({
            variant: 'destructive',
            title: 'Error',
            description: 'Something went wrong while deleting project. Please try again.'
         });
      } finally {
         setOpen(false);
         setIsLoading(false);
         ...
         <DialogContent className=''>
            <DialogHeader>
               ...
               <DialogDescription className='p-2'>
                  Are you sure you want to delete this project? You will not be able to recover it. All tasks will be deleted as well.
               </DialogDescription>
            </DialogHeader>
            <DialogFooter className='space-x-2'>
               <Button className='px-2' variant='default' onClick={() => setOpen(false)}>
                  Cancel
               </Button>
